...
int ISHIKARI=00000, MATSUMAE=463, FUKUSHIMA=758, SHIRIUCHI=927, KIKONAI=1096; 
int HOKUTO=1271, HAKODATE=1483, NANAE=1957, SHIKABE=2209, MORI=2311; 
int YAKUMO=2565, OSHAMANBE=2776, KAMINOKUNI=3001, ESASHI=3272, ASSABU=3565; 
int OTOBE=3803, OKUSHIRI=4005, SETANA=4117, IMAKANE=4380, SHIMAMAKI=0000; 
...
int SAPPORO_SHIROISHI=00000, SAPPORO_ATSUBETSU=00000, SOURCE=4559;
