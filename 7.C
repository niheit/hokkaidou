...
int HOKUTO=1104, HAKODATE=1280, NANAE=1700, SHIKABE=1912, MORI=1988; 
int YAKUMO=2207, OSHAMANBE=2381, KAMINOKUNI=2574, ESASHI=2807, ASSABU=3066; 
int OTOBE=3253, OKUSHIRI=3416, SETANA=3504, IMAKANE=3735, SHIMAMAKI=0000; 
...
int SAPPORO_SHIROISHI=00000, SAPPORO_ATSUBETSU=00000, SOURCE=3888;
