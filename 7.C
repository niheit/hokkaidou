...
int OSHIMA=224, HIYAMA=308, SHIRIBESHI=0000, IBURI=0000, HIDAKA=0000; 
int ISHIKARI=00000, MATSUMAE=422, FUKUSHIMA=677, SHIRIUCHI=824, KIKONAI=968; 
int HOKUTO=1103, HAKODATE=1279, NANAE=1685, SHIKABE=1897, MORI=1973; 
int YAKUMO=2192, OSHAMANBE=2366, KAMINOKUNI=2559, ESASHI=2792, ASSABU=3051; 
int OTOBE=3238, OKUSHIRI=3401, SETANA=3489, IMAKANE=3720, SHIMAMAKI=0000; 
...
int SAPPORO_SHIROISHI=00000, SAPPORO_ATSUBETSU=00000, SOURCE=3873;
