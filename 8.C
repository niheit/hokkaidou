...
int NAIE=2093, ASHIBETSU=2232, SHIN_TOTSUKAWA=2378, SUNAGAWA=2600; 
int KAMI_SUNAGAWA=2733, UTASHINAI=2827, URYUU=2998, TAKIKAWA=3267; 
int AKABIRA=3497, HOKURYUU=3650, MOSEUSHI=3766, FUKAGAWA=3883; 
int CHIPPUBETSU=4096, NUMATA=4241, MASHIKE=0000, RUMOI_CITY=0000, OBIRA=0000;
